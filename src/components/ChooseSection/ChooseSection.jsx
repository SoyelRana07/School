  ...
  return (
    <div>
        <div className="container">
            <h2 className='text-center mb-5'>Why choose Heritage School ?</h2>
            <div className='row g-4'>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            The Heritage School Kolkata has been ranked as the top co-educational day school in the city by the Education world magazine.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            ...
                            <Card.Text className='text-center'>
                            The Heritage School is a unique effort of imparting education combined with modern state of the art technology and expertise. The mission behind this day-boarding school is to provide a systematic and holistic education opportunity to students.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='d-flex align-items-center border-0 h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='text-center text-capitalize mb-3'>
                                Partnership with 4 countries
                            </Card.Title>
                            <Card.Text className='text-center'>
                            We have student-exchange programmes with the UK and with Germany, where pupils have the unique opportunity to visit the partner school and stay with host families. They also get the opportunity to host a pupil from the UK or Germany.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
