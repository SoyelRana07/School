    ...
    <div className='home-page'>
        <header className='h-100 min-vh-100 d-flex align-items-center text-light'>
            <div className='container d-flex flex-column align-items-center'>
                <h2>Welcome To</h2>
                <h1 className='text-center fw-semibold'>The Heritage School</h1>
                <p>Schooling for tomorrow. Schooling from Tradition</p>
            ...
            <div className="container">
                <div className='row d-flex align-items-center justify-content-around'>
                    <div className='col-lg-5'>
                        <h2 className='text-capitalize'>ADMISSIONS 2025-26 ongoing</h2>
                        <p>Online registrations for academic session 2025-26 for Pre-Nursery, Nursery & Class I-XII is now open.</p>
                        <Link to="/courses">
                            <button type='button' className='btn btn-danger btn-lg mx-0 mx-sm-2 my-2 my-sm-0'>Check out our courses</button>
                        </Link>
                    </div>
