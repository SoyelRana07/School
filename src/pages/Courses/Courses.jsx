      ...
      <div className='courses-page'>
          <header className='height-75'>
              <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                  ...
                  <p className='text-center w-75 mb-5'>The Heritage School believes that the students should become global citizens while retaining their traditional values. Keeping this in mind, all the important national days and festivals are celebrated in the school through celebrations and special assemblies. The essence of the festival or the special day is portrayed through dance, music, mime, role play, and audio visual presentations. </p>
              </div>
          </header>
                      ...
                      <div key={course.id} className='col-lg-6'>
                          <div className='course-card'>
                              <Card className='text-white shadow'>
                                  <Card.Img src={course.img} className='course-image fluid-image' />
                                  <Card.ImgOverlay className='d-flex flex-column align-items-center justify-content-center overlay'>
